...
function detectForbiddenLastChar(
  name /*: string */,
  restrictions /*: PathRestrictions */
) /*: ?string */ {
...
function detectNameLengthIssue(
  name /*: string */,
  restrictions /*: PathRestrictions */
) /*: ?number */ {
...
function detectDirNameLengthIssue(
  name /*: string */,
  restrictions /*: PathRestrictions */
) /*: ?number */ {
...
function detectPathIssues(
  ...
  const pathIssues = detectNameIssues(basename, type, platform).map(nameIssue =>
    _.merge({ path }, nameIssue)
  )

  const recursivePathIssues = ancestorNames.reduceRight(
    (previousIssues, name, index, pathComponents) => {
...
function detectPathLengthIssue(
  path /*: string */,
  platform /*: string */
) /*: ?PathLengthIssue */ {
