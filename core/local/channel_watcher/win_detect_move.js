 ...
 * renamed event.
 *
 * @module core/local/channel_watcher/win_detect_move
 * @flow
 */
...
export type WinDetectMoveState = {
  [typeof STEP_NAME]: {
    ...
    unmergedRenamedEvents: SortedSet<ChannelEvent>
  }
}
...
async function initialState() /* Promise<WinDetectMoveState> */ {
  return {
    [STEP_NAME]: {
      ...
      unmergedRenamedEvents: new SortedSet /*:: <ChannelEvent> */ ()
    }
  }
}

function forget(event /*: ChannelEvent */, state /*: WinDetectMoveState */) {
  const {
