  ...
  describe('with replacing move', () => {
    ...
    it('sorts child move of replaced before move of replacing', () => {
      ...
      const moveReplaced = {
        ...
        doc: builders
          .metadir()
          .path('dirC/dir/empty-subdir-a')
          .build(),
        was: builders
          .metadir()
          .path('dirA/dir/empty-subdir-a')
          .build()
      }
    ...
    it('sorts child move of replaced and child move of replacing by deleted path', () => {
      const moveReplacing = {
        ...
        doc: builders
          .metadir()
          .path('dirA/dir/subdir')
          .build(),
        was: builders
          .metadir()
          .path('dirB/dir/subdir')
          .build()
      }
      const moveReplaced = {
        type: 'DescendantChange',
        doc: builders
          .metadir()
          .path('dirC/dir/empty-subdir')
          .build(),
        was: builders
          .metadir()
          .path('dirA/dir/empty-subdir')
          .build()
      }
  ...
  describe('with move inside move', () => {
    it('sorts moves before descendant moves', () => {
      const fileMove2 = {
        ...
        was: builders
          .metafile()
          .path('parent/dst/dir/subdir/file2')
          .build()
      }
  ...
  describe('sorts deleted before created for the same path', () => {
    ...
    it('when there are other changes', () => {
      ...
      const fileTrash = {
        ...
        doc: builders
          .metafile()
          .path('.cozy_trash/fichier.pptx')
          .build(),
        was: builders
          .metafile()
          .path('1_Dossier/fichier.pptx')
          .build()
      }
    ...
    context('with replacing move', () => {
      it('sorts replacing move after move of replaced', () => {
        ...
        const emptySubdirbMove = {
          ...
          doc: builders
            .metadir()
            .path('dirA/dir/empty-subdir-b')
            .build(),
          was: builders
            .metadir()
            .path('dirB/dir/empty-subdir-b')
            .build()
        }
        const subdirMoveB = {
          type: 'DescendantChange',
...
describe('isChildSource(p, c)', () => {
  it('returns true if p src path is parent of c src path', () => {
    ...
    const child = {
      ...
      doc: builders
        .metafile()
        .path('parent/dst2/file')
        .build(),
      was: builders
        .metafile()
        .path('parent/src/dir/subdir/file')
        .build()
    }
  ...
  it('returns false if p src path is not parent of c src path', () => {
    ...
    const child = {
      ...
      doc: builders
        .metafile()
        .path('parent/dst/subdir/file')
        .build(),
      was: builders
        .metafile()
        .path('parent/src2/file')
        .build()
    }
