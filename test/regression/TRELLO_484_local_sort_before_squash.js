...
// FIXME: remove if tests pass on macOS
  ...
  describe('TRELLO #484: Local sort before squash (https://trello.com/c/RcRmqymw)', function() {
    ...
    it('is fixed', async function() {
      await init(
        {
          init: [
            ...
            {
              ino: 3,
              path: 'eBooks/Learning JavaScript/Learning JavaScript.epub'
            },
            { ino: 4, path: 'eBooks/Mastering Cassandra/' },
            {
              ino: 5,
              path: 'eBooks/Mastering Cassandra/9781782162681_CASSANDRA.pdf'
            },
      ...
      await runActions(
        {
          actions: [
            {
              type: 'mv',
              src: 'facture-boulanger.pdf',
              dst: 'Administratif/facture-boulanger.pdf'
            },
            { type: 'mv', src: 'eBooks', dst: 'Livres' },
            // XXX: File is deleted after flush but before analysis (race condition):
            {
              type: 'mv',
              src: 'Administratif/facture-boulanger.pdf',
              dst: 'Administratif/facture-boulanger2.pdf'
            }
          ]
        },
      ...
      await helpers.local.simulateEvents([
        ...
        {
          type: 'add',
          path: 'Administratif/facture-boulanger.pdf',
          stats: {
            ino: 9,
            size: 209045,
            mtime: new Date('2017-10-09T08:40:44.298Z'),
            ctime: new Date('2017-10-09T08:40:44.298Z')
          }
        },
        ...
        { type: 'unlinkDir', path: 'eBooks' },
        {
          ...
          stats: {
            ino: 1,
            size: 4096,
            mtime: new Date('2017-10-09T08:40:51.472Z'),
            ctime: new Date('2017-10-09T08:40:51.472Z')
          }
        },
        {
          type: 'addDir',
          path: 'Livres/Learning JavaScript',
          stats: {
            ino: 2,
            size: 4096,
            mtime: new Date('2017-10-09T08:40:51.478Z'),
            ctime: new Date('2017-10-09T08:40:51.478Z')
          }
        },
        {
          type: 'addDir',
          path: 'Livres/Mastering Cassandra',
          stats: {
            ino: 4,
            size: 4096,
            mtime: new Date('2017-10-09T08:40:51.479Z'),
            ctime: new Date('2017-10-09T08:40:51.479Z')
          }
        },
        {
          type: 'addDir',
          path: 'Livres/Mastering Node.js',
          stats: {
            ino: 6,
            size: 4096,
            mtime: new Date('2017-10-09T08:40:51.479Z'),
        ...
        {
          type: 'add',
          path: 'Livres/Mastering Node.js/book.mobi',
          stats: {
            ino: 7,
            size: 16760,
            mtime: new Date('2017-10-09T08:40:52.521Z'),
            ctime: new Date('2017-10-09T08:40:52.521Z')
          }
        },
        {
          type: 'add',
          path: 'Livres/Mastering Node.js/book.pdf',
          stats: {
            ino: 8,
            size: 286325,
            mtime: new Date('2017-10-09T08:40:52.521Z'),
        ...
        {
          type: 'add',
          path: 'Livres/Learning JavaScript/Learning JavaScript.epub',
          stats: {
            ino: 3,
            size: 1699609,
            mtime: new Date('2017-10-09T08:40:52.521Z'),
        ...
        {
          type: 'add',
          path: 'Livres/Mastering Cassandra/9781782162681_CASSANDRA.pdf',
          stats: {
            ino: 5,
            size: 3091364,
            mtime: new Date('2017-10-09T08:40:52.522Z'),
            ctime: new Date('2017-10-09T08:40:52.522Z')
          }
        }
      ])
      ...
      await helpers.local.simulateEvents([
        ...
        {
          type: 'add',
          path: 'Administratif/facture-boulanger2.pdf',
          stats: {
            ino: 9,
            size: 209045,
            mtime: new Date('2017-10-09T08:40:44.298Z'),
