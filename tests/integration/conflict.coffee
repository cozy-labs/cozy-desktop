...
describe 'Conflict with two files', ->
    @slow 1000
    @timeout 10000
...
describe 'Conflict between a local file and a remote folder'
describe 'Conflict between a local folder and a remote file'
describe 'Conflict when moving a file'
describe 'Conflict when moving a folder'
describe 'Conflict between 2 remotes files with distinct cases'
