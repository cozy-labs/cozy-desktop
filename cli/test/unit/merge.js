...
describe('Merge', function () {
  ...
  describe('trashFolderAsync', () => {
    it('does not trash a folder it the other side has added a new file in it', async function () {
      const dir = await builders.dirMetadata().path('trashed-folder').trashed().create()
      await builders.fileMetadata().path('trashed-folder/file').notUpToDate().create()
